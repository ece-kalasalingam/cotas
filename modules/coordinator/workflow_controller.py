"""Workflow state helpers for CoordinatorModule."""

from __future__ import annotations

from typing import Protocol, cast

from modules.coordinator.validators.attainment_thresholds import (
    has_valid_attainment_thresholds,
)


class CoordinatorWorkflowController:
    def __init__(self, module: object) -> None:
        self._m = cast(_CoordinatorWorkflowModule, module)
    ...
    def notify_threshold_violation(self, *, force: bool) -> None:
        if self._m._threshold_violation_active and not force:
            return
        self._m._show_threshold_validation_toast()
        self._m._publish_status_key(self._m._THRESHOLD_VALIDATION_KEY)
...
class _CoordinatorWorkflowModule(Protocol):
