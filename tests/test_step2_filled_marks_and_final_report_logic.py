...
from modules.instructor.steps import step2_filled_marks_and_final_report as step3
...
def test_upload_filled_marks_async_early_returns_for_busy_or_cancelled_dialog() -> None:
    ...
    step3.upload_filled_marks_async(module, ns=ns)
...
def test_upload_filled_marks_async_success_paths() -> None:
    ...
    step3.upload_filled_marks_async(module2, ns=ns2)
...
def test_generate_final_report_async_early_gate_paths() -> None:
    ...
    module.state.busy = True
    step3.generate_final_report_async(module, ns=ns)
    assert module.started == {}
    ...
    step3.generate_final_report_async(module, ns=ns_cancel)
    assert module.started == {}
...
def test_generate_final_report_async_source_missing_and_success() -> None:
    ...
    try:
        ...
        step3.generate_final_report_async(module2, ns=ns2)
