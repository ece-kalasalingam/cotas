...
TEXTS = {
    ...
    "instructor.validation.step3.template_validator_missing": "No Step 2 validator available for template '{template_id}'.",
    ...
    "coordinator.list_placeholder": "Drag and Drop, or press Ctrl + O, or double-click to add files",
