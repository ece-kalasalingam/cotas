...
TEXTS = {
    ...
    "outputs.title": "Generated Outputs",
    "outputs.none_generated": "No outputs generated.",
    "outputs.open_file": "Open file",
    "outputs.open_folder": "Open folder",
    "outputs.open_failed": "Unable to open the selected path.",
    # Instructor module
    ...
    "instructor.action.download_course_template": "Download Course Template",
    "instructor.action.download_course_template_link_html": '<a href="{href}">{text}</a>',
    "instructor.action.generate_marks_template": "Prepare Marks Template",
    ...
    "instructor.dialog.course_template.save_title": "Save Course Details Template",
    "instructor.dialog.course_template.default_name": "course_details_template.xlsx",
    "instructor.dialog.course_details.select_title": "Select Course Details File",
    "instructor.dialog.marks_template.save_title": "Save Marks Template",
    "instructor.dialog.marks_template.default_name": "marks_template.xlsx",
    "instructor.status.template_download_path_selected": "Template download path selected.",
    "instructor.status.course_details_validated": "Course details uploaded and validated. You can now prepare marks template.",
    "instructor.status.marks_template_generated": "Marks template generated.",
    "instructor.status.course_details_replaced": "Course details changed. Redo downstream steps.",
    "instructor.status.operation_cancelled": "Operation cancelled.",
    "instructor.status.course_details_drop_browse_requested": "Course details browse requested from drag-and-drop widget.",
    "instructor.status.course_details_drop_files_dropped": "{count} file(s) dropped into course details widget.",
    "instructor.status.course_details_drop_files_changed": "Course details widget now has {count} file(s).",
    "instructor.status.course_details_drop_files_rejected": "{count} dropped file(s) were rejected by course details widget.",
    "instructor.status.course_details_validation_progress": "Validated valid files: {valid}/{total}.",
    "instructor.status.marks_template_generation_progress": "Processed marks templates: {processed}/{total}.",
    "instructor.status.marks_template_per_file_failures": "Marks-template per-file failures: {details}",
    "instructor.drop.summary": "Files: {count}",
    ...
    "activity.log.ready": "Activity log initialized.",
    ...
    "validation.template.unknown": "Unknown workbook template '{template_id}'. Available templates: {available}.",
    ...
    "validation.dependency.openpyxl_missing": "openpyxl is not installed. Install it to validate uploaded course details.",
    "instructor.validation.workbook_not_found": "Course details workbook not found: {workbook}",
    "validation.workbook.not_found": "Course details workbook not found: {workbook}",
    "instructor.validation.workbook_open_failed": "Unable to open course details workbook '{workbook}'.",
    "validation.workbook.open_failed": "Unable to open course details workbook '{workbook}'.",
    "instructor.validation.system_sheet_missing": "Missing required system sheet '{sheet}' in uploaded workbook.",
    "validation.system.sheet_missing": "Missing required system sheet '{sheet}' in uploaded workbook.",
    "instructor.validation.system_hash_missing_template_id_header": "Invalid system hash sheet format: missing Template_ID header.",
    "validation.system_hash.header_template_id_missing": "Invalid system hash sheet format: missing Template_ID header.",
    ...
    "validation.system_hash.header_template_hash_missing": "Invalid system hash sheet format: missing Template_Hash header.",
    "instructor.validation.system_hash_template_id_missing": "Template_ID is missing in system hash sheet.",
    "validation.system_hash.template_id_missing": "Template_ID is missing in system hash sheet.",
    "instructor.validation.system_hash_mismatch": "Template hash mismatch. Please use a valid generated template.",
    "validation.system_hash.mismatch": "Template hash mismatch. Please use a valid generated template.",
    ...
    "validation.layout.sheet_missing": "Missing required layout sheet '{sheet}' in filled marks workbook.",
    "instructor.validation.step2.layout_header_mismatch": "Invalid layout sheet header at {column}. Expected '{expected}'.",
    "validation.layout.header_mismatch": "Invalid layout sheet header at {column}. Expected '{expected}'.",
    "instructor.validation.step2.layout_manifest_missing": "Layout manifest or layout hash is missing in system layout sheet.",
    "validation.layout.manifest_missing": "Layout manifest or layout hash is missing in system layout sheet.",
    "instructor.validation.step2.layout_hash_mismatch": "Layout hash mismatch. Please use an untampered generated marks template.",
    "validation.layout.hash_mismatch": "Layout hash mismatch. Please use an untampered generated marks template.",
    "instructor.validation.step2.layout_manifest_json_invalid": "Layout manifest JSON is invalid.",
    "validation.layout.manifest_json_invalid": "Layout manifest JSON is invalid.",
    "validation.template.validator_missing": "No Step 2 validator available for template '{template_id}'.",
    ...
    "validation.mark.entry_empty": "Sheet '{sheet_name}' has an empty mark-entry cell at {cell}. Fill all marks before upload.",
    ...
    "validation.mark.value_invalid": "Sheet '{sheet_name}' cell {cell} has invalid mark value '{value}'. Allowed: A/a or numeric between {minimum} and {maximum}.",
    ...
    "validation.mark.precision_invalid": "Sheet '{sheet_name}' cell {cell} has too many decimal places in '{value}'. Maximum allowed is {decimals}.",
    ...
    "validation.mark.indirect_integer_required": "Sheet '{sheet_name}' cell {cell} has invalid indirect mark '{value}'. Use an integer Likert value.",
    ...
    "validation.mark.absence_policy_violation": "Sheet '{sheet_name}' row {row} has mixed absence and numeric entries in {range}. Enter either all A/a or all numeric marks.",
    ...
    "co_analysis.dialog.select_files": "Select files for analysis",
